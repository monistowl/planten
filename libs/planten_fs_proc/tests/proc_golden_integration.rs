...
use planten_9p::{
    RawMessage, build_frame, encode_attach_body, encode_open_body, encode_read_body,
    encode_version_body, messages::*,
};
...
impl Operation {
    fn new(msg_type: u8, body: Vec<u8>, expected_response: &'static str) -> Self {
        Operation {
            msg_type,
            body,
            expected_response,
...
fn operations() -> Vec<Operation> {
    vec![
        ...
        Operation::new(TOPEN, encode_open_body(1, 0), "ropen_root_response.bin"),
        Operation::new(
            TREAD,
...
#[test]
fn proc_golden_trace_matches_server() {
