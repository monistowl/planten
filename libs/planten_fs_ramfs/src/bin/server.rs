...
fn main() -> io::Result<()> {
...

    {
        ...
        guard.create_file("/hello.txt", b"Hello from planten_9p");
...
fn handle_client(mut stream: TcpStream, ramfs: Arc<Mutex<RamFs>>) -> io::Result<()> {
...
fn handle_walk(
    ...
    fid_paths.insert(newfid, current_path);
