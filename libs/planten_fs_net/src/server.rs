...
pub fn run_single(listener: TcpListener, fs: Arc<Mutex<NetFs>>) -> io::Result<()> {
...
fn handle_client(mut stream: TcpStream, fs: Arc<Mutex<NetFs>>) -> io::Result<()> {
...
fn root_inode() -> Inode {
    Inode::new("net", 0o555 | 0x80000000, "root", "root")
}
